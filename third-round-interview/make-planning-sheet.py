...
Output: "Similarity Tool - Planning Sheet.docx" beside this script.
...
def build(path):
    ...
    run(eyebrow, "UNIPLUS EDUCATION · KOC FINAL ROUND", size=8, bold=True,
        color=GREEN, spacing=1.1)
    ...
    run(subtitle, "Topic: Similarity · S2 JM17  |  10 minutes  |  "
    ...
    question(
        ...
        "你想這個工具達到什麼結果？",
        "One specific thing about similarity — not “understand similarity better”. "
    ...
    run(line, "the idea fits in 50 minutes  ·  the student has to commit to an answer  ·  "
              "the tool says why an answer is wrong  ·  the mathematics matches the JM17 note",
...
if __name__ == "__main__":
    out = Path(__file__).with_name("Similarity Tool - Planning Sheet.docx")
